...
storiesOf("Button", module)
  ...
  .add("Base", () => <Button>Default</Button>)
...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form student="Travis" interviewer={0} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
